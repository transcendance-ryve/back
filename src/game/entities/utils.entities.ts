...
export const	TICK_INTERVAL: number = 1000 / 100;		// interval of time between each frame
...
export const	MAX_BALL_SPEED: number = 8;
...
export const	BONUSES_START: number = 5; // in seconds
...
export const	SIZE_DECREASE_PATH: string = "../bonuses_images/game-controller.svg";
export const	SIZE_INCREASE_PATH: string = "../bonuses_images/friends.svg";
export const	REVERSE_KEYS_BONUS_PATH: string = "../bonuses_images/bell.svg";
export const	SLOWER_BONUS_PATH: string = "../bonuses_images/Play.svg";
export const	SNIPER_BONUS_PATH: string = "../bonuses_images/Eye.svg";